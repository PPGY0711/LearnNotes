...
//	System.out.println(ii[0]);//使用动态初始化的时候，数组的元素会有默认值，数字类型的默认值是0，对象类型的默认值是null
//	boolean[] b = new boolean[2];//布尔类型的默认值是false
//	System.out.println(b[0]);
//	char[] cs = new char[2];
//	System.out.println(cs[0]+"ss");//字符类型的默认值是' '。
//	
		//静态化定义多维数组
//		int[][] i = new int[][] {
//			{1,2},
...
//		};
		//i[1][1] = 4;
//		int[][] ii = new int[3][2];//第一维的长度是3，第二维的长度，也就是第一维的每个元素的长度是2
//		{
//			{1,2}
//			{3,4}
//			{5,6}
...
//		int[][] iii = new int[2][]; //只定义第一维的长度，第二维不定义，这样子的话第二维默认是空的数组。
//	int res = 0;
//		int[][] arr = new int[][] {
//		{3,8,2},
//		{2,7},
